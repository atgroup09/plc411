...
class YAPLCIdeLauncher(BeremizIDELauncher):
    ...
    def __init__(self):
	    ...
	    ('PLC411_MAIN', 'PLC411_MAIN.PLC411_MAIN'),
            ('PLC411_SYS', 'PLC411_SYS.PLC411_SYS'),
	    ('PLC411_DI', 'PLC411_DI.PLC411_DI'),
            ('PLC411_DO', 'PLC411_DO.PLC411_DO'),
            ('PLC411_AI', 'PLC411_AI.PLC411_AI')]
